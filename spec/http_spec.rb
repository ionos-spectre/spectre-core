...
RSpec.describe 'spectre/http' do
  context do
    before do
      ...
      @http_client = Spectre::Http::HttpClient.new({}, @logger, [])
    end
    ...
    it 'does some HTTPS request with given certificate' do
    ...
    it 'does some HTTP request with basic auth' do
      ...
      http_client = Spectre::Http::HttpClient.new({}, @logger, [Spectre::Http::BasicAuth])
    ...
    it 'does not override HTTP config' do
      ...
      http_client = Spectre::Http::HttpClient.new(http_cfg, @logger, [Spectre::Http::BasicAuth])
  ...
  it 'does some HTTP request with keystone auth' do
    ...
    http_client = Spectre::Http::HttpClient.new({}, logger, [Spectre::Http::Keystone])
